...
async function getStartManifest() {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-DB7-j7Ij.js");
...
const manifest = { "3dffc64eabe29fc8f5f4021f5e1cdf4bfea9319ffba3a59848ead9dcd2fa0308": {
  ...
  importer: () => import("./assets/_-DFbtpK86.js")
} };
...
function createStartHandler(cb) {
  ...
  const getEntries = async () => {
    if (routerEntry === null) {
      routerEntry = await import("./assets/router-B6vVXVXg.js").then((n) => n.l);
    }
    if (startEntry === null) {
